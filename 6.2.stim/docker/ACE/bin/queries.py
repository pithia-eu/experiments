...
def recentStorms():
    ...
    df.to_csv(r'/home/model/API/queries/recentStorms.csv', index=False, header=True)
    print(data)
...
def minBx():
    ...
    if not data:
        ACELogger.logger.info(f"No data found ")
    df = pd.DataFrame.from_dict(data)
    df.to_csv(r'/home/model/API/queries/minBx.csv', index=False, header=True)
    print(data)
...
def maxBx():
    ...
    if not data:
        ACELogger.logger.info(f"No data found ")
    df = pd.DataFrame.from_dict(data)
    df.to_csv(r'/home/model/API/queries/maxBx.csv', index=False, header=True)
    print(data)
...
def minBy():
    ...
    if not data:
        ACELogger.logger.info(f"No data found ")
    df = pd.DataFrame.from_dict(data)
    df.to_csv(r'/home/model/API/queries/minBy.csv', index=False, header=True)
    print(data)
...
def maxBy():
    ...
    if not data:
        ACELogger.logger.info(f"No data found ")
    df = pd.DataFrame.from_dict(data)
    df.to_csv(r'/home/model/API/queries/maxBy.csv', index=False, header=True)
    print(data)
...
def minBz():
    ...
    if not data:
        ACELogger.logger.info(f"No data found ")
    df = pd.DataFrame.from_dict(data)
    df.to_csv(r'/home/model/API/queries/minBz.csv', index=False, header=True)
    print(data)
...
def maxBz():
    ...
    if not data:
        ACELogger.logger.info(f"No data found ")
    df = pd.DataFrame.from_dict(data)
    df.to_csv(r'/home/model/API/queries/maxBz.csv', index=False, header=True)
    print(data)
...
def minBmag():
    ...
    if not data:
        ACELogger.logger.info(f"No data found ")
    df = pd.DataFrame.from_dict(data)
    df.to_csv(r'/home/model/API/queries/minBmag.csv', index=False, header=True)
    print(data)
...
def maxBmag():
    ...
    if not data:
        ACELogger.logger.info(f"No data found ")
    df = pd.DataFrame.from_dict(data)
    df.to_csv(r'/home/model/API/queries/maxBmag.csv', index=False, header=True)
    print(data)
