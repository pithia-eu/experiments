...
!
  ...
  latpas=3
!
  open(3,file='DTM20F107Kp_ro.dat',status='new')
  open(6,file='DTM20F107Kp_Tz.dat',status='new')
  open(8,file='DTM20F107Kp_Tinf.dat',status='new')
  open(11,file='DTM20F107Kp_He.dat',status='new')
  open(12,file='DTM20F107Kp_O.dat',status='new')
  open(13,file='DTM20F107Kp_N2.dat',status='new')
!
